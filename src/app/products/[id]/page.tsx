...
import { ShoppingCart, ArrowLeft, Plus, Minus, Check, Droplet, Ruler, Scissors, Palette, Sparkles, ShieldCheck, Info } from 'lucide-react';
          ...
          <div className="lg:w-1/2 p-8 lg:p-12 flex flex-col rounded-b-3xl lg:rounded-r-3xl lg:rounded-bl-none bg-white">
                  ...
                  {availableFabrics.map(opt => {
                    ...
                    return (
                      <button
                        ...
                        className={`py-3.5 px-4 rounded-xl border-2 text-sm font-bold text-left transition-all flex justify-between items-center ${isSelected
                  ...
                  {availableWeights.map(opt => {
                    ...
                    return (
                      <button
                        ...
                        className={`py-3 px-2 rounded-xl border-2 text-xs font-bold transition-all flex items-center justify-center gap-1 ${isSelected
                  ...
                  {availableFits.map(opt => {
                    ...
                    return (
                      <button
                        ...
                        className={`py-3 px-3 rounded-xl border-2 text-xs font-bold transition-all flex items-center justify-between ${isSelected
                            ? 'border-orange bg-orange/5 text-orange shadow-sm'
                  ...
                  {availableColors.map(colorObj => {
                    ...
                    return (
                      <button
                        ...
                        className={`relative w-10 h-10 rounded-full border-2 transition-all flex items-center justify-center transform hover:scale-110 ${isSelected ? 'border-orange ring-4 ring-orange/20 scale-105' : 'border-gray-300'
                          }`}
                  ...
                  {availableAdditional.map(opt => {
                    ...
                    return (
                      <button
                        ...
                        className={`py-3 px-4 rounded-xl text-xs font-bold border-2 transition-all flex items-center justify-between ${isSelected
            ...
            <div className="mt-10 pt-8 border-t border-gray-100 flex flex-col md:flex-row items-end gap-6">
              ...
              <button
                ...
                className={`w-full flex-1 h-[60px] rounded-xl font-extrabold text-lg flex items-center justify-center gap-3 transition-all ${isFormValid
