                  ...
                  {fabricOptions.map(opt => {
                    ...
                    return (
                      <button
                        ...
                        className={`py-4 px-4 rounded-xl border-2 text-sm font-bold text-left transition-all flex justify-between items-center ${isSelected
                  ...
                  {gsmOptions.map(opt => {
                    ...
                    return (
                      <button
                        ...
                        className={`py-3 px-2 rounded-xl border-2 text-sm font-bold transition-all flex items-center justify-center gap-1 ${isSelected
                  ...
                  {decorationOptions.map(opt => {
                    ...
                    return (
                      <button
                        ...
                        className={`py-2.5 px-5 rounded-lg text-sm font-bold border-2 transition-all ${isSelected
